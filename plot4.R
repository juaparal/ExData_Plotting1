...
##Program plot4.R for Course Project 1
...
png(filename = "./plot4.png", width = 480, height = 480, bg = "grey55")
...
with(tidy, {
  ...
  legend("topright", bty = "n", lty = 1, lwd=c(2.5,2.5,2.5), col = c("black","blue", "red"), legend = c("Sub_metering_1", "Sub_metering_2","Sub_metering_3"))
